...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>@lang('Autenticação de Usuário')</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="{{ route('login.access') }}" method="POST">
					@csrf
                    <span class="login100-form-title">
						<img src="{{ URL::asset('login/images/titulo_pet_livre.jpg'); }}" width="181" height="101">
					</span>

					<div class="wrap-input100 validate-input" data-validate = "É obrigatório um E-mail válido: ex@abc.xyz">
